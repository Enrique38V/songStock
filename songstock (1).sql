...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-06-2024 a las 11:38:47
...
INSERT INTO `listareproduccion` (`idLista`, `idComprador`, `nombre`, `descripcion`) VALUES
(2, 2, 'PEERROOOS', NULL),
(5, NULL, NULL, NULL),
(6, NULL, NULL, NULL),
(8, 5, 'BOLERITOS DE AMOR', 'AMOR'),
(9, 5, 'Cantina', 'Tiene perreo');
...
(13, 'Palida', 'Robert Tiamo', 'RAP', NULL, '20000.00', 6, NULL);
...
(6, 'Enrique', 'Federico', 'enrique.federico', 'MTIzNDU2Nzg5', NULL, 'federico@enrique.com', NULL, 'VENDEDOR');
...
--
ALTER TABLE `musica`
  MODIFY `idMusica` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
